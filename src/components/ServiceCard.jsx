...
const ServiceCard = ({ title, description, icon: Icon, longDescription = '' }) => {
  ...
  return (
    <div
      className="relative bg-[#112240] rounded-xl border border-gray-800 overflow-hidden h-full transition-all duration-700 hover:border-cyan-500/30 min-h-[280px]"
    ...
    >
      ...
      <div
        className={`relative z-10 p-6 md:p-8 h-full flex flex-col items-center justify-center text-center md:items-start md:text-left transition-all duration-700 ${
      ...
      <div
        className={`absolute inset-0 p-8 transition-all duration-700 z-10 flex flex-col ${
