...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--border)] bg-black/60 backdrop-blur-lg opacity-90 mt-16">
      <div className="container mx-auto px-4 py-8 md:py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          {/* Copyright */}
          <p className="text-sm text-[var(--muted)] text-center md:text-left">
            © {currentYear} July Franz Claridad. All rights reserved.
          </p>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((link) => (
              <a
                ...
                className="p-2 rounded-full hover:bg-white/10 text-[var(--muted)] hover:text-white transition-colors duration-200"
              >
