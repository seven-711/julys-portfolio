        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              ...
              <div className="relative h-full rounded-2xl p-6 overflow-hidden" style={{ '--fade-color': '#ffff' }}>
                ...
                <div className="absolute bottom-24 left-0 right-0 h-28 bg-gradient-to-t from-[var(--fade-color)] via-[var(--fade-color)] via-30% to-transparent z-10 pointer-events-none"></div>
                <VerticalLogoLoop
                  items={[
                    {
