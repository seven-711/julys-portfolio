...
export default function About(){
  ...
  return (
    <div className="container mt-24 space-y-6">
      ...
      />                  
      <div 
        className="glassmorphism p-6 rounded-2xl border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)] 
      ...
      <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            <div className="space-y-4">
              ...
              <section className="mb-4">
                ...
                />
                <div 
                  className="glassmorphism mt-6 mb-8 p-6 rounded-2xl backdrop-blur-lg border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)] 
                    transition-all duration-500 ease-in-out
                    hover:shadow-[0_8px_60px_rgba(255,255,255,0.1)]
                    hover:border-white/20
                    hover:scale-[1.02]
        ...
        <div>
                <TextType
                  ...
                  className="text-2xl font-bold mb-4" 
                />
          <div className="glassmorphism p-6 rounded-2xl mt-6 mb-8 border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)]
